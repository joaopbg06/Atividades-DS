...
<style type="text/css">
    ...
    /* Back to top button */
    .back-to-top {
        background: <?php echo $cor_sistema ?> ;color: #fff;
    }
                    ...
                    <form action="enviar.php" method="post" class="form-horizontal contactForm" role="form">
                        <div class="col-md-offset-2 col-md-8">
                            <div class="form-group">
                                <input type="text" name="nome" class="form-control" id="name" placeholder="Seu Nome" data-rule="minlen:4" data-msg="Pelo menos 4 caracteres" />
                        ...
                        <div class="col-md-offset-2 col-md-8">
                            <div class="form-group">
                                <textarea class="form-control" name="mensagem" rows="5" data-rule="required" data-msg="Insira sua Mensagem" placeholder="Messagem"></textarea>
                                <div class="validation"></div>
                            </div>
                        </div>
                        <div class="form-group">
